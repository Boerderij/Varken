...
class TautulliStream(NamedTuple):
    ...
    stream_video_color_primaries: str = None
    stream_video_color_range: str = None
    stream_video_color_space: str = None
    stream_video_chroma_subsampling: str = None
    stream_video_color_trc: str = None
